...
placebo tests and the main test. **binwidth**: Numeric. Width of the
histogram bins (default = 0.1).
...
# seed for reprodubility
set.seed(123)


# n=3000 observations of a running variable on [−150,10]
n <- 3000
df_sim <- data.frame(
...
# simulate outcome with jumps at discontinuity and various placebo jumps
main_cut    <- 0
main_eff    <- 1
...
# RDD‐based UESD (default uses optimal bandwidth, conventional se, and placebos)
